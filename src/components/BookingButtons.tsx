...
export default function BookingButtons({ variant = "cta", className = "" }: BookingButtonsProps) {
  const primaryButtonClass = variant === "hero" 
    ...
    : variant === "compact"
    ? "group inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-gradient-lime text-primary-foreground font-medium tracking-wider uppercase text-xs rounded-md transition-all duration-300 cursor-pointer hover:scale-105 hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    : "inline-flex items-center gap-2 px-6 py-3 bg-gradient-lime text-primary-foreground font-medium tracking-wider uppercase text-sm rounded-lg hover:scale-105 hover:brightness-110 transition-all duration-300";
